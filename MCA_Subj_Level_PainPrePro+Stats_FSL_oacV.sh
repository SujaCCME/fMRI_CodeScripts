...
# NOTE : move any and all older feat level runs into ./FSL_Pain/First_Level_Subj_Analyses/older_first_level/ folder
...
do
    ...
    do     
        ...
        # check for any data with scrubbed volumes ; move any and all older feat level runs into older_first_level folder
        INPUT=${DATADIR}/MCA${SUBJ}_Ses${SES}/Pain_func/MCA${SUBJ}_Ses${SES}_Pain_corrected_scrubbed.nii.gz
        
        # run the script with the following INPUT for non-scrubbed dataset
